...
st.markdown("""
    ...
    - Na análise de *feature importance* destacamos 2: A primeira delas (e mais influente) a exportação/consumo de combustíveis fósseis, com um foco e importância maior na Índia (3º maior consumidor de petróleo no mundo) [https://www.gov.br/anp/pt-br/centrais-de-conteudo/publicacoes/anuario-estatistico/arquivos-anuario-estatistico-2022/secao-1/texto/secao1.pdf].
